...
class AboutMeViewMedium extends StatelessWidget {
  final AboutMeController controller;
  const AboutMeViewMedium({Key? key, required this.controller})
      : super(key: key);
